...
export const LocationsModal = (props) => {
  ...
  const [modalOpen, setModalOpen] = useState(props.OpenedModal || true);
      ...
      >
        ...
        >
          <span
            ...
            onClick={(e) => {
              props.handleLocation("all");
            }}
          >
            <Icon fontSize={"15px"} icon={"mingcute:location-line"}></Icon>
            <span sx={{ width: "fit-content" }} primary={""}>
              All Location
            </span>
          </span>
      ...
      <Box sx={style}>
        <Autocomplete
          ...
          renderOption={(props, option) => (
            <Box
              component="li"
              sx={{ "& > img": { mr: 2, flexShrink: 0 }, zIndex: "2700" }}
              {...props}
            >
              {option.location}
            </Box>
        ...
        />
        {/* <CustomAutocomplete
        options={newLocations.map((val) => val.location)}
        onSelect={(e) => {
      ...
      /> */}
        ...
        >
          <Typography
            ...
            component="h2"
            sx={rowsStyle}
            style={{ marginTop: "20px", color: "#B6255A" }}
            onClick={(e) => {
              props.handleLocation("all");
              setModalOpen(!modalOpen);
            }}
