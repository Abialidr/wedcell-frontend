          ...
          <div className="col-md-2 col-6">
            <div className="footer-widget">
              ...
              >
                ...
                <a
                  target="_blank"
                  href="https://www.linkedin.com/company/wedfield/mycompany/?viewAsMember=true"
                  style={{
                    display: "flex",
                    alignItems: "center",
                    gap: "5px",
                ...
                <Link
                  href={
                    "https://play.google.com/store/apps/details?id=com.wedding.wedfield&pcampaignid=web_share"
                  }
                >
                  <li style={{ marginTop: "10px" }}>
                    <Image
                      src={`${S3PROXY}/public/images/webp/Google-Play.webp`}
                      height={"50"}
                      width={"130"}
                      alt="Google Play"
                    />
          ...
          <div className="col-md-2 col-6" style={{ paddingRight: "20px" }}>
            <div className="footer-widget">
              ...
              <ul className={Styles.listnone1}>
                <li>Are you vendor ? List your</li>
                <li>Venue and Service get more from listing business.</li>
                {role !== "Students" && (
                  <li>
                    <button
                      ...
                      style={{
                        background:
                          "linear-gradient(180deg, #C53244 0%, #B4245D 100%)",
                      }}
                    >
                      <a target="_blank" href="https://vendors.wedfield.com/">
                        List Your Buisness
                      </a>
                    </button>
                  </li>
