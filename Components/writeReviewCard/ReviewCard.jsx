...
const ReviewCard = ({
  ...
  return (
    <div style={{ width: mobile ? '100%' : '40%', marginTop: '10px' }}>
      <div className=' px-3'>
        <h4 className='fw-bold text-left'>Add Review</h4>

        <span className='d-block text-left'>Your Rating</span>

        <div className=' stars-container d-flex align-items-start  justify-content-start'>
            ...
            >
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  const res = await deleteReview(oneReview._id);
