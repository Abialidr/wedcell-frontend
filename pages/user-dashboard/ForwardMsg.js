...
import { useGetAllContactsQuery } from "redux/Api/chw.api";
const ForwardMsg = ({ isOpen, setOpenModal, openModal, message }) => {
  ...
  }, [globleuser, isOpen, openModal, allContacts]);
  const style = {
    position: "absolute",
    top: "50%",
    left: "50%",
                ...
                <div>
                  ...
                  >
                    {connections?.map((person) => (
                      <li
                        key={person.vendorId ? person.vendorId : person.id}
                        style={{
                          display: "flex",
                          alignItems: "center",
                          padding: "5px",
                        ...
                        >
                          ...
                          >
                            <img
                              ...
                              style={{ minWidth: "40px" }}
                              src={
                                person.vendorImage ? person.vendorImage : null
                              }
